...
struct Emotion: Identifiable, Hashable {
    ...
    static let negative: [Emotion] = [
        ...
        Emotion(name: "Anxiety", emoji: "😰", question: "What way of living feels uncertain or unstable?", category: .negative, color: Color(red: 0.70, green: 0.50, blue: 0.70)),
        ...
        Emotion(name: "Betrayal", emoji: "🗡️", question: "What way of living was violated by someone you trusted?", category: .negative, color: Color(red: 0.60, green: 0.30, blue: 0.30)),
        ...
        Emotion(name: "Contempt", emoji: "😏", question: "What way of living do you see being degraded?", category: .negative, color: Color(red: 0.58, green: 0.42, blue: 0.42)),
        ...
        Emotion(name: "Dread", emoji: "😱", question: "What way of living feels like it's approaching and unavoidable?", category: .negative, color: Color(red: 0.50, green: 0.32, blue: 0.55)),
        ...
        Emotion(name: "Exhaustion", emoji: "🪫", question: "What way of living has drained you beyond recovery?", category: .negative, color: Color(red: 0.52, green: 0.48, blue: 0.45)),
        ...
        Emotion(name: "Insecurity", emoji: "🫣", question: "What way of living feels like it could be pulled away?", category: .negative, color: Color(red: 0.65, green: 0.52, blue: 0.62)),
        ...
        Emotion(name: "Melancholy", emoji: "🌧️", question: "What way of living do you long for without knowing why?", category: .negative, color: Color(red: 0.45, green: 0.50, blue: 0.65)),
        ...
        Emotion(name: "Resentment", emoji: "😒", question: "What way of living was taken from you by someone specific?", category: .negative, color: Color(red: 0.72, green: 0.42, blue: 0.35)),
        Emotion(name: "Restlessness", emoji: "🌀", question: "What way of living do you need but can't settle into?", category: .negative, color: Color(red: 0.48, green: 0.58, blue: 0.65)),
    ...
    static let positive: [Emotion] = [
        ...
        Emotion(name: "Freedom", emoji: "🕊️", question: "What way of living are you no longer constrained in?", category: .positive, color: Color(red: 0.55, green: 0.72, blue: 0.82)),
        ...
        Emotion(name: "Playfulness", emoji: "🎈", question: "What way of living invites you to be lighthearted?", category: .positive, color: Color(red: 0.88, green: 0.48, blue: 0.48)),
